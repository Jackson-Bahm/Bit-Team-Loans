#!/usr/bin/php
 <?php
$api_key = "AqUuYAMo1npJ93OPsT5Wpyzt9MlvTY27bm5y2OUT4cj";
$api_secret = "FCqNgBSoUyvEaDzoAwWrrFWtmGidoK9veM7Ldr8spy6";
class bitfinex{
  private $apikey;
  private $secret;
  ...
  "method":"bitcoin",
  "currency":"BTC",
  "address":"3FdY9coNq47MLiKhG2FLtKzdaXS3hZpSo4Click to send altcoins to this BTC address "
   }
   */
   ...
   */
   public function margin_limits()
   {
   $request = "/v1/margin_limits";
   $data = array(
      "request" => $request
   );
   return $this->hash_request($data);
   ...
   */
   ...
   private function hash_request($data)
   {
	...
	$stat = new bitfinex($api_key, $api_secret);
	$statshow1 = $stat->fetch_balance($data);
	echo(" ");
